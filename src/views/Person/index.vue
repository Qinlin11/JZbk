<template>
  <div class="prepare">
    <el-breadcrumb
      ...
      style="position: absolute; top: 15px; left: 155px"
    >
      ...
      >
      <el-breadcrumb-item :to="{ path: '/plan' }" style="font-weight: 600"
        >教学设计首页</el-breadcrumb-item
      >
      <el-breadcrumb-item style="font-weight: 600">教学设计</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="prepare-div">
      <div class="save-design" @click="saveRea">
        <button class="button" style="color:#ffffff">保存教学设计</button>
      </div>
      <div class="prepare-top">
        ...
        <!-- <div class="prepare-top-right" @click="$router.push('/plan')">
          <div class="right-bg">
      ...
      <div class="prepare-main">
        <div class="main-mid">
          ...
          >
            <keep-alive>
              <router-view :detailInfo="test1? test1[0]:''"></router-view>
            </keep-alive>
          </transition>
        </div>
      </div>
  ...
  methods: {
    async saveRea() {
      try {
        ...
        this.$message.error(`保存失败了..,${error.message}`);
      }
    },
    getIndex(index) {
      ...
      switch (index) {
        case 0:
          this.$router.push("/person/fir");
          break;
        case 1:
          this.$router.push("/person/sec");
          break;
        case 2:
          this.$router.push("/person/thr");
          break;
        case 3:
          this.$router.push("/person/fou");
          break;
        default:
          this.$router.push("/person/fiv");
          break;
      }
    },
  },
